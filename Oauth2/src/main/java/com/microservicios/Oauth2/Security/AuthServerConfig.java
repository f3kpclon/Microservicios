...
public class AuthServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    private InfoAdicionalClaimsToken infoAdicionalClaimsToken;
    @Autowired
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
        ...
        tokenEnhancerChain.setTokenEnhancers(Arrays.asList(accessTokenConverter(),infoAdicionalClaimsToken));
